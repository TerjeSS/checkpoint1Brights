...
VALUES ('Tolkien', 'Tolkien@theshire.com', 'Theonering', 'GOAT?'),
		('Rothfuss', 'Pat@theman.com', 'wordsofthewind', 'big beard')



INSERT INTO Article(AuthorId, Title, Slug, Description, Body, CreatedAt, UpdatedAt)
VALUES
(3, 'Lord of the Rings', 'LOTR', 'Theyr taking the hobbits to isengard', 'Not gonna write the whole book', NOW(), NOW()),
(1, 'Song of ice and fire', 'GoT', 'Sean Bean always dies', 'Lots of text here', NOW(), NOW());
